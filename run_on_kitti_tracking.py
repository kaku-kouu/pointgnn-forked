...
if IS_TEST:
    ...
    dataset = KittiDataset(
        os.path.join(DATASET_DIR, 'training/image_02'),
        os.path.join(DATASET_DIR, 'training/velodyne/'),
        os.path.join(DATASET_DIR, 'training/calib/'),
        os.path.join(DATASET_DIR, 'training/label_02'),
        DATASET_SPLIT_FILE,
        num_classes=config['num_classes'])
